...
function exhaustiveBest(ctx,policies,excluded=[],rankIndex=0,topLimit=200,progressInfo=null,quotaSpec=null,proProfile=null,rankingConfig=null,boundary=null){
  ...
  if(invalidBoundary||forced.some(n=>block.has(n)))return{game:null,score:-Infinity,tested:0,total:0,approvedCount:0,eligibleCount:0,rankIndex,topGames:[],topScores:[],diagnostics:{boundaryRejected:true,start,end,reason:invalidBoundary?'Faixa início/fim impossível':'Dezena inicial/final bloqueada'}};
  ...
  eachComb(pool,choose,gref=>{const g=[...forced,...gref].sort((a,b)=>a-b);tested++;
